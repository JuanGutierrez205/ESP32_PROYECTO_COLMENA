<?php
// PROGRAMA DE Monitoreo de colmenas (sin distinción de apicultor)
...
// Verificamos que el tipo de usuario exista en la tabla tipo_usuario
...
<html>
<head>
    <title>Consultar colmenas</title>
    <meta charset="utf-8">
</head>
<body>
...
<table width="100%" align=center cellpadding=5 border=0 bgcolor="#FFFFFF">
    <tr valign="top">
        <td height="20%" align="left" bgcolor="#FFFFFF" class="_espacio_celdas">
            <font FACE="arial" SIZE=2 color="#e65100"><b><h1>Consultar colmenas</h1></b></font>
        </td>
...
<table width="100%" align=center cellpadding=5 border=0 bgcolor="#FFFFFF">
    <tr>
        <td colspan=2 align="left" bgcolor="#FFFFFF" class="_espacio_celdas">
            <table width=90% border=1 align=center>
                ...
                <?php
                // Hacemos JOIN con usuarios para traer el nombre del responsable
                $sql1 = "
                    SELECT c.*, u.nombre_completo AS nombre_apicultor
                    FROM colmenas c
                    LEFT JOIN usuarios u ON c.id_apicultor = u.id
                    ORDER BY c.id_tarjeta
                ";
                ...
                if ($result1) {
                    while ($row1 = $result1->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFF3E0" align=center><?php echo htmlspecialchars($row1['nombre_apicultor']); ?></td>
                            ...
                            <td bgcolor="#FFF3E0" align=center>
                                <a href="mapa_consultar.php?latitud=<?php echo urlencode($row1['latitud']); ?>&longitud=<?php echo urlencode($row1['longitud']);  ?>&estado=<?php echo urlencode($row1['estado_colmena']); ?>&nombre=<?php echo urlencode($row1['nombre_colmena']); ?>" target="_blank">
                    ...
                    echo "<tr><td colspan='9' align='center'>No hay colmenas registradas.</td></tr>";
                }
                ?>
            </table>
        </td>
